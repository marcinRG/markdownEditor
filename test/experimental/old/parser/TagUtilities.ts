...
//     }
//
//     public static findMultiLineTag(resultArray: RegExpMatchArray): IMatchResults {
//         if (resultArray && resultArray.length && resultArray[0]) {
//             printResultTable(resultArray);
//             return findList(resultArray);
//         }
//         return null;
//     }
//
...
// };
//
// const findList = (resultsArray: RegExpMatchArray): IMatchResults => {
//     if (resultsArray[1]) {
//         return {
//             matchedText: resultsArray[1],
//             tag: HTMLTags.UL,
//             innerText: resultsArray[1],
//         }
//     }
//     return findQuote(resultsArray);
// };
//
// const findQuote = (resultsArray: RegExpMatchArray): IMatchResults => {
//     if (resultsArray[2]) {
//         return {
//             matchedText: resultsArray[2],
//             tag: HTMLTags.QUOTE,
//             innerText: resultsArray[2]
//         }
//     }
//     return null;
// };
