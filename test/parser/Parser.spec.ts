...
describe('Parser tests', () => {
    ...
    it('', () => {
        ...
        let parentNode: INode = new TagNode(HTMLTags.DIV);
        Parser.parseText(textToParse,parentNode);
        expect(parentNode.toString()).toBe(`<${HTMLTags.DIV}>Jakis tekst <${HTMLTags.H1}>Weekly JavaScript Challenge #9</${HTMLTags.H1}></${HTMLTags.DIV}>`);
    })
});